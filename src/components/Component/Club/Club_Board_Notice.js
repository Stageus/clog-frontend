...
const Club_Board_Notice = (props) => {
    ...
    return (
        <React.Fragment>
            <Flexdiv flex="0_0_auto_raw_flex-start_center" width="860px" height="40px" customBorder="0_0_1px_0_solid_#DADADA" backgroundColor="#F0F0F0">
...
export default Club_Board_Notice