    ...
    return (
        <React.Fragment>
            <Flexdiv flex="0_0_auto_raw_space-between_center" width="860px" height="40px" customBorder="0_0_1px_0_solid_#DADADA">
                <Flexdiv textAlign="start" width="530px" padding="0 10px 0 10px" font="14px_600_'Noto Sans KR', sans-serif" textOver="hidden_nowrap_ellipsis" cursor="pointer">{elem.title}</Flexdiv>
