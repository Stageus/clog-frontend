...
const Promote_CategoryResult_Club = (props) => {
    ...
    return (
        <React.Fragment>
            <Flexdiv flex="0_1_auto_column_flex-start_center" width="390px" height="320px" backgroundColor="#f0f0f0" radius="10px" margin="20px">
                ...
                <Flexdiv flex="0_1_auto_row_flex-start-center" width="350px" margin="10px 0 10px 0">
                    ...
                    {elem.isMember &&
                        <Flexdiv flex="2_1_auto_row_flex-end_flex-start" color="#aaaaaa" fontSize="14px">
                            <Flexdiv flex="0_1_auto" margin="0 2px 0 0">가입됨</Flexdiv>
                            <Svgcheck flex="0_1_auto" fill="#aaaaaa" width="14px" height="14px" />
                        </Flexdiv>}
                </Flexdiv>

                {/* 소개글 본문 */}
                <Flexdiv flex="0_1_auto_row_center_flex-start" width="360px" height="205px" backgroundColor="#ffffff" radius="10px" margin="0 0 5px 0">
                    <P flex="0_1_auto" width="360px" height="180px" textAlign="left" margin="10px">{elem.cover}</P>
                </Flexdiv>
            </Flexdiv>
        </React.Fragment>
    )
