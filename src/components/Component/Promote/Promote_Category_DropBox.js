...
const Promote_Category_DropBox = (props) => {
    // props ======================================================
    const { base, list, width, height } = props
                ...
                {dropBoxOpen ?
                    <Flexdiv flex="0_1_auto_column_center_center" width={width} outline="2px solid #333333" backgroundColor="#ffffff" radius="10px">
                        <Flexdiv flex="0_1_auto_row_space-between_center" width={width} height={height} outline="2px solid #c4c4c4" radius="10px 10px 0 0">
                            <Span flex=" 0_1_auto" color="#aaaaaa" margin="0 0 0 10px" >{base}</Span>
                        ...
                        <Flexdiv width={width} backgroundColor="#ffffff" margin="2px 0 0 0">
                            {list.map((elem) =>
                                <HoverDiv flex="0_1_auto_row_space-between_center" width={width} height={height} color="#aaaaaa" backgroundColor="#ffffff">
                                    <Span flex=" 0_1_auto" margin="0 0 0 10px">{elem}</Span>
                                </HoverDiv>)}
                        </Flexdiv>
                    </Flexdiv> :
