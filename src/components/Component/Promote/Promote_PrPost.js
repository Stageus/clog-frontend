...
const Promote_PrPost = (props) => {
    // props ======================================================
    const { elem, sidemargin } = props
    let side = ""
    if (sidemargin == undefined) {
        side = "0px"
    }
    else {
        side = sidemargin
    ...
    return (
        <React.Fragment>
            <Flexdiv flex="0_1_auto_column_center_center" width="240px" height="390px" margin={"10px " + side}>
                <Flexdiv id="prpost" flex="0_1_auto_column_center" width="fit-content" height="fit-content" >
                    <Flexhidden id="prpost" flex="0_1_auto_row_center_center" width="210px" height="297px" backgroundColor="#f2f2f2" radius="10px" margin="0 0 5px 0">
                        <Img id="prpost" flex="0_1_auto" src={elem.thumbnail} width="210px" />
                    </Flexhidden>
                ...
                <Flexdiv flex="0_1_auto_row_center_center" width="210px" height="50px">
                    {/* 홍보물 작성한 동아리로고 */}
                    <Flexdiv flex="0_1_auto_row_center_center" width="50px" height="50px" margin="0 4px"><Img flex="0_1_auto" src={elem.clubImage} width="50px" radius="50%" /></Flexdiv>
                    {/* 홍보물작성한 동아리 이름, 댓글개수 */}
