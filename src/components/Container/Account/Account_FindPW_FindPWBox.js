...
const Account_FindPW_FindPWBox = () => {
    // props ============================================================
        ...
        <React.Fragment>
            <Flexdiv onClick={clickEvent} width="100%" flex="0_1_auto_row_center_center">
                <Flexdiv flex="0_1_auto_column_center_center" width="460px" margin="0px 0 50px 0">
                    ...
                    {/* 비밀번호 찾기 버튼(인증완료버튼) */}
                    <Account_Button id="gosignup" flex="0_1_auto_row_center_center" height="55px" backgroundColor="#333333" font="24px_700" inner="비밀번호 찾기" margin="90px 0 0 0" />
                </Flexdiv>
            </Flexdiv>
...
export default Account_FindPW_FindPWBox