...
const Club_ClubProfileBox = () => {
    ...
    return(
        <React.Fragment>
            <Flexdiv width="190px" height="315px" margin="0 0 20px 0" padding="3px 5px 0px" borderTop={"2px solid #" + club[0].theme_color} cursur="default">
                ...
                <Flexdiv width="190px" height="60px" margin="20px 0 20px">
                    ...
                    <Flexdiv flex="0_0_auto_row_flex-start_center" height="20px">
                        ...
                        <Span fontFamily="'Nanum Gothic', sans-serif" fontSize="10px" fontBold="400" color="#C4C4C4">{timeTranslate(club[0].create_at)}</Span>
                    </Flexdiv>
                    <Flexdiv flex="0_0_auto_row_flex-start_center" height="20px">
                        <Flexdiv flex="0_0_auto_row_center_center" width="20px" height="20px">
                            <Users width="10px" height="10px" fill="#C4C4C4"/>
                        </Flexdiv>
                        <Span fontFamily="'Nanum Gothic', sans-serif" fontSize="10px" fontBold="400" color="#C4C4C4">100명</Span>
                    </Flexdiv>
                </Flexdiv>

                <Flexbutton flex="0_0_auto_row_center_center" width="190px" height="40px" radius="10px" backgroundColor={"#" + club[0].theme_color}>
