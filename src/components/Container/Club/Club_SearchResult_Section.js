...
import { clubPostListAtom, searchresultpageAtom } from "../../../recoil/NavAtom"
// import styled
...
const Club_SearchResult_Section = () => {
    // route ============================================================
    ...
    const [page, setPage] = useRecoilState(searchresultpageAtom)
...
export default Club_SearchResult_Section
